...
//    @objc dynamic var genres : [String] = []
    ...
    convenience init(movie_id: Int, imdb_id: String, title: String, overview: String, duration: Int, /*budget: Double,*/ popularity: Double, releaseDate: String, /*revenue: Double,*/ status: String, tagline: String, vote_average: Double, votecount: Int, stars: String, /*genres : [String],*/ poster_path: String, trailerUrl: String) {
